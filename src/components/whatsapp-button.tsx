...
export const WhatsAppButton = component$<WhatsAppButtonProps>(
  ({
    phone = "5491152604447",
    message = "¡Hola! Vengo desde la web de Koop Viajes y me gustaría recibir más información sobre sus paquetes y ofertas.",
  }) => {
    if (!phone) {
      return null;
    }
    ...
    return (
      <a
        ...
        class="group fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-xl transition-transform duration-300 ease-in-out hover:scale-110 sm:h-16 sm:w-16"
